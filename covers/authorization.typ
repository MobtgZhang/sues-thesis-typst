#import "../thesis.typ": fontstypedict,fontsizedict,linespacing
#set align(center)
#text("上海工程技术大学\n学位论文版权使用授权书",size:fontsizedict.三号,font:fontstypedict.黑体)
...
#align(left + top,
    ...
    grid(
      ...
      gutter: 1em,
      "",rect(width: 9pt, height: 9pt),text("保密",weight: "semibold",font:fontstypedict.黑体)," ，在年解密后适用本授权书。",
      "本学位论文属于","","","",
